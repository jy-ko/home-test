...
ActiveRecord::Schema.define(version: 2022_06_15_100831) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["authenticable_type", "authenticable_id"], name: "index_users_on_authenticable_type_and_authenticable_id"
